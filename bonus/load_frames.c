...
{
	data->img_enemy_up[0] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/eu1.xpm",
	&data->tile_size, &data->tile_size);
	data->img_enemy_up[1] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/eu2.xpm",
	&data->tile_size, &data->tile_size);
	data->img_enemy_up[2] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/eu3.xpm",
	&data->tile_size, &data->tile_size);
	data->img_enemy_up[3] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/eu4.xpm",
	&data->tile_size, &data->tile_size);
	data->img_enemy_down[0] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/ed1.xpm",
	&data->tile_size, &data->tile_size);
	data->img_enemy_down[1] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/ed2.xpm",
	&data->tile_size, &data->tile_size);
	data->img_enemy_down[2] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/ed3.xpm",
	&data->tile_size, &data->tile_size);
	data->img_enemy_down[3] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/ed4.xpm",
	&data->tile_size, &data->tile_size);
...
{
		data->img_enemy_left[0] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/el1.xpm",
		&data->tile_size, &data->tile_size);
		data->img_enemy_left[1] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/el2.xpm",
		&data->tile_size, &data->tile_size);
		data->img_enemy_left[2] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/el3.xpm",
		&data->tile_size, &data->tile_size);
		data->img_enemy_left[3] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/el4.xpm",
		&data->tile_size, &data->tile_size);
		data->img_enemy_right[0] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/er1.xpm",
		&data->tile_size, &data->tile_size);
		data->img_enemy_right[1] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/er2.xpm",
		&data->tile_size, &data->tile_size);
		data->img_enemy_right[2] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/er3.xpm",
		&data->tile_size, &data->tile_size);
		data->img_enemy_right[3] = mlx_xpm_file_to_image(data->mlx, "bonus/assets/er4.xpm",
		&data->tile_size, &data->tile_size);
}
